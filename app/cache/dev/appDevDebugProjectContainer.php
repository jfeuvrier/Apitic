...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'AnimalsDB', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Ap/PlatformBundle/Entity'))), 'Ap\\PlatformBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('ApPlatformBundle' => 'Ap\\PlatformBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_80c556dc82f2626dc76d2d130596f302f5bca883bc4dba9ff162512e42264725');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Ap/PlatformBundle/Resources/views'), 'ApPlatform');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('6537a3268ebb27b3785925f25b04fe47552b305a');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('590b201c1f6249.81288766')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ApPlatformBundle' => 'Ap\\PlatformBundle\\ApPlatformBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'ApPlatformBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Ap/PlatformBundle'),
                    'namespace' => 'Ap\\PlatformBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
            ...
            'secret' => '6537a3268ebb27b3785925f25b04fe47552b305a',
            'locale' => 'en',
            ...
            'kernel.secret' => '6537a3268ebb27b3785925f25b04fe47552b305a',
